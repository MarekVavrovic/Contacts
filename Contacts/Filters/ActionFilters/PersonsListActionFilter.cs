...
namespace Contacts.Filters.ActionFilters
{
    public class PersonsListActionFilter : IActionFilter
    {
            ...
            personsController.ViewBag.SearchFields = new Dictionary<string, string>()
      {
        ...
        {
            //before logic - Parameters validation
            ...
            if (context.ActionArguments.ContainsKey("searchBy"))
            {
                ...
                if (!string.IsNullOrEmpty(searchBy))
                {
                    ...
                    if (searchByOptions.Any(temp => temp == searchBy) == false)
                    {
                       ...
                       var result= context.ActionArguments["searchBy"] = nameof(PersonResponse.PersonName);
                        _logger.LogInformation("searchBy updated value {searchBy}", result);
                    }
                }
            }
        }
